            ...
            <div class="card">
              <div class="card-header">
                <div class="row">
                  ...
                  <div class="col">
                    <h3 class="text-center my-4 text-uppercase">${exerciseToDelete.name}</h3>
                  </div>
              ...
              <div class="card-body">
                  <div class="row my-2">
                    <span class="text-center">
                        Are you sure you want to delete exercise ${exerciseToDelete.name}?<br>
                        Be aware that it will be deleted from all <b class="text-decoration-underline">workout plans</b> as well.
                    </span>
                  </div>
                  <div class="row my-4">
                      <div class="col d-flex justify-content-center">
                          <a class="btn btn-dark text-decoration-none text-white mt-2"
                             href="/exercise/delete/confirm/${exerciseToDelete.id}" role="button">
                              Confirm
