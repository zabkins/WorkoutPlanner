                        ...
                        <div class="row">
                            ...
                            <div class="row mt-2">
                                <p class="h4 text-center">
                                    No plans created yet. Add new one by choosing correct option
                    ...
                    <div class="container-fluid">
                        <div class="row my-1">
                            ...
                            <div class="col d-flex justify-content-center">
                                <h1 class="text-uppercase">${activeWorkoutPlan.name}</h1>
                            </div>
                            <div class="col-2 d-flex justify-content-end">
                                <a class="btn btn-dark text-decoration-none text-white my-2"
                                   href="/plan/edit/${activeWorkoutPlan.id}"
                                   role="button">
                                    Edit Plan
                        ...
                        <div class="row">
                            <div class="d-flex justify-content-center">
                                <h5 class="text-secondary">Active Workout Plan</h5>
                            </div>
                        </div>
                        <div class="row align-items-center my-1">
                            <div class="col">
                                <div class="card">
                                    ...
                                    <c:choose>
                                        <c:when test="${not empty activeWorkoutPlan.trainingDays}">
                                            <div class="row row-cols-3 d-flex justify-content-start">
                                                <c:forEach items="${activeWorkoutPlan.trainingDays}" var="tday"
                                                           varStatus="loop">
                                                    <div class="col px-3">
                                                        <div class="card my-2">
                                                            <div class="card-body">
                                                            ...
                                                            <ul class="list-group list-group-flush">
                                                                <li class="list-group-item text-center"><b>EXERCISES</b>
                                                                </li>
                                                ...
                                                <div class="col">
                                                    <div class="col d-flex justify-content-center">
                                                        <button type="button" class="btn btn-dark">
                                                            <a href="/tday/add/${workoutPlanToEdit.id}"
